...
public class BSTMap 
{
	...
	{
		List<Integer> oList = new LinkedList<Integer>();
		if(root == null)
		{
			return oList;
		}
		...
		{
			return root.traversePreOrder(oList);
		}
	...
	public List<Integer> traverseInOrder()
	{
		...
		{
			return root.traverseInOrder(oList);
		}
	}
	...
	public List<Integer> traversePostOrder()
	{
		...
		{
			return root.traversePostOrder(oList);
		}
	 ...
	 * 
	 * @return List of node keys in levelorder traversal
	 */
	public List<Integer> traverseLevelOrder()
	{
		...
		{
			return root.traverseLevelOrder(oList);
		}
	}
}
